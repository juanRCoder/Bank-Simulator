    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log(response.ok, data.accountNumber, data.deposit, data.name)
            } else {
                ...
                <div className="form_area">
                    ...
                    <form action="/sendDeposit"
                        ...
                        <div className="form_group">
                            <label className="sub_title" htmlFor="accountNumber">Account Number</label>
                        ...
                        <div className="form_group">
                            <label className="sub_title" htmlFor="dni">DNI</label>
